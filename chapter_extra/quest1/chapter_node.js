...
module.exports = {
  ...
  steps: [
    ...
    {
      chat: "Great work!!  It looks like the countdown has stopped!  Thank you so much, now we have electricity. Click <a href=\"javascript:{}\" onclick=\"window.angularComponentRef.zone.run(function () { window.angularComponentRef.completeChapter()})\">here</a></form> to continue.",
      questions: [
      ],
      statusFunction:
        function(req, res) {
